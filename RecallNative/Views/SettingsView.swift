        ...
        NavigationStack {
            Form {
                ...
                Section("On-device AI") {
                    ...
                    Text("Generation runs locally using LiteRT-LM. You can also import a deck generated by another AI using the JSON format.").font(.caption).foregroundStyle(.secondary)
                }
                Section("About") {
